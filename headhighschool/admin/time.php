<?php
    ...
    include_once('../connection.php');
                    ...
                    //query
                    $sql1 ="SELECT COUNT(time_id) from  time";
                    ...
                    $sql = "SELECT * from  time, year WHERE time.year_id = year.year_id  ORDER BY time_id DESC $limit";
...
<head>
    ...
    <title>หน้าแสดงผลเวลาการเรียน</title>
...
<body>
    ...
    <div class="main">
        <div class="container">
            <div class="display-3 text-center">หน้าแสดงผลเวลาการเรียน</div>
            <div class="col-xs-6">
                <a href="add_time.php" class="btn btn-success mb-3"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                        height="16" fill="currentColor" class="bi bi-person-plus-fill" viewBox="0 0 16 16">
                        <path d="M1 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z">
                        <path fill-rule="evenodd"
                            d="M13.5 5a.5.5 0 0 1 .5.5V7h1.5a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0V8h-1.5a.5.5 0 0 1 0-1H13V5.5a.5.5 0 0 1 .5-.5z">
                    </svg> เพิ่มเวลาในการเรียน</a>
            ...
            ?>
                    <tr>
                        <td><?php echo $row1["time_name"]; ?></td>
                        <td><?php echo $row1["term"].'/'.$row1["year_name"]; ?></td>
                        ...
                        <td><a href="delete_time.php?delete_id=<?php echo $row1["time_id"]; ?>" class="btn btn-danger "
                                onclick="return confirm('คุณต้องการลบข้อมูลหรือไม่')">ลบข้อมูล</td>
                        <td><a href="change_status_time.php?change_id=<?php echo $row1["time_id"]; ?>"
                                class="btn btn-info "
