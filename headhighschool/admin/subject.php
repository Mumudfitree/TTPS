<?php
    ...
    $query=mysqli_query($conn,"SELECT COUNT(subject_id) FROM subject");
                        ...
                        $sql = "SELECT * from subject, grade_level as grade WHERE subject.grade_id = grade.grade_id ORDER BY subject_id DESC $limit";
                        if(isset($_GET['search'])){ 
                            $search = $_GET['search'];
                            $sql = "SELECT * from subject, grade_level as grade WHERE subject.grade_id = grade.grade_id AND subject.code_subject LIKE '%" . $search . "%' OR name_subject LIKE '%" . $search . "%' ORDER BY subject_id DESC $limit ";
                        }
