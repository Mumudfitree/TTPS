...
if (!isset($_SESSION['headhighschool_login'])) {//คำสั่งต้องloginก่อนถึงเข้าได้
        ...
        <tbody>
            <?php
                ...
                ?>  
                    ...
                    <tr>
                    <?php if(($row['grade_id'] == '4' ||$row['grade_id'] == '5' ||$row['grade_id'] == '6') && $row['status_prepare_week']=='Checking' ){ ?>
