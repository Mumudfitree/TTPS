<?php
    ...
    WHERE pre.choose_id = report.choose_id AND report.subject_id =sub.subject_id AND report.class_id = class.class_id AND report.master_id = login.master_id AND  login.master_id = $id ORDER BY id_prepare DESC $limit");
...
<div class="main">
    ...
    <?php }else{ ?>
    <div id="pagination_controls"><?php echo '' ?></div>
</div>
<div class="col-lg-2">
</div>
<?php } ?>
