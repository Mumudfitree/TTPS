<?php
    ...
    if(isset($_REQUEST['btn_insert'])){
        ...
        if(empty($goal)){
            ...
            try{
                if(!isset($errorMsg)){
                    $insert_stmt = $db->prepare("INSERT INTO weekly_summary(choose_id,date_prepare_week,goal,result,activity_good,activity_nogood,problem,student,solve_the_problem)
