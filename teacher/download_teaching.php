...
?>
        ...
        echo $row["fname"].' '.$row["lname"];
         ...
         ?>
                <tr class="tr">
                    <th rowspan="2" align="center" valign="middle" height="50" class="th">วัน/เวลา</th>
                    <?php 
                    for ($i = 1; $i <= $kab; $i++) { ?>

                    <th align="center" valign="middle" height="50" class="th"><?php echo "คาบที่ $i"; ?></th>
                    <?php } ?>
                </tr>
                <tr class="tr">
                    <?php while($row1 =  mysqli_fetch_array($query1)){ ?>
                    <th align="center" valign="middle" height="50" class="th" ><?php echo $row1["time_name"]; ?></th>
                    <?php } ?>
                </tr>
    ...
    /*for($i_time=1;$i_time<8/* คาบ*//*;$i_time++){    //เวลา
        ...
        $arr_detailShow[$i_time]=$dataShow;// array ชื่อและเวลา
            ...
            ?>
                ...
                <tr class="tr">
                    <td align="center" valign="middle" height="50"  class="td"><?php echo $thai_day_arr[$i_day];  ?></td>
                    <!--วัน-->
                    <?php
