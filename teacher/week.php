<?php
    ...
    WHERE user.user_id = login.user_id AND week.choose_id = c.choose_id AND c.subject_id =sub.subject_id AND c.class_id = class.class_id AND c.login_id = login.login_id AND  login.user_id = $id ORDER BY id_prepare_week DESC $limit");
