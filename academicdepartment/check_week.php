...
$nquery=mysqli_query($conn,"SELECT * from  weekly_summary ORDER BY id_prepare_week DESC $limit");
...
<?php include_once('aca_slidebar.php'); ?>
    ...
    <div class="display-3 text-center">ตรวจสอบสรุปผลรายสัปดาห์</div>
            ...
            <?php
                ...
                ?>  
                    ...
                    <tr>
                        ...
                        <td><a target ="_blank" href="download_hours.php?download_id=<?php echo $row["id_prepare_week"]; ?>" class="btn btn-dark">ดาวน์โหลด</a></td>
