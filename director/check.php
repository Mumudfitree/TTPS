...
WHERE pre.choose_id = c.choose_id AND c.class_id = class.class_id AND c.subject_id = sub.subject_id AND c.grade_id = grade.grade_id  AND c.master_id = login.master_id ORDER BY id_prepare DESC $limit");
