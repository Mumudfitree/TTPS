    ...
    <div class="main">
        ...
        function search() {
            ...
            <?php
                ...
                ("SELECT * FROM choose_a_teaching as report, subject, classroom as class, login_information as user, grade_level as grade, year WHERE report.subject_id = subject.subject_id AND report.class_id = class.class_id AND report.year_id = year.year_id AND report.master_id = user.master_id AND report.grade_id = grade.grade_id ORDER BY choose_id DESC;");
                $select_stmt->execute();
