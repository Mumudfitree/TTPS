...
WHERE user.user_id = login.user_id AND pre.choose_id = c.choose_id AND c.class_id = class.class_id AND c.subject_id = sub.subject_id AND c.grade_id = grade.grade_id AND c.login_id = login.login_id
        ...
        <tbody>
            <?php
                ...
                ?>  
                    ...
                    <tr>
                    <?php if(($row['grade_id'] == '1' ||$row['grade_id'] == '2' || $row['grade_id'] == '3') && $row['status_prepare_hours']=='Checking' ){ ?>
